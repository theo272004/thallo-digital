        ...
        <div className="relative hidden lg:block h-[860px] 2xl:h-[1000px]">
          ...
          >
            ...
            <path
              ...
              fill="none" stroke="#39471D" strokeMiterlimit="10" strokeWidth="3"
            />
            <path
              ref={bRama1Ref}
          ...
          <div className="relative flex flex-col gap-14 2xl:gap-20">
            ...
            <div ref={step1Ref} className="opacity-40 transition-opacity duration-500 flex gap-6 items-start justify-center lg:justify-start">
              ...
              <div>
                ...
                {/* What the phase hands over. Named deliverables rather than
                    ...
                    The hover edge is the industry cards' own — `#55672E` at
                    40%, over 300ms — so the two read as the same gesture. Only
                ...
                <div className="flex flex-wrap gap-1.5 mt-3.5">
                  <span className="text-[12px] font-medium text-gray-800 bg-white border border-gray-200 rounded-full px-3 py-1 transition-colors duration-300 hover:border-[#39471D] hover:bg-[#E7ECD9] hover:text-[#39471D]">Visibility baseline</span>
                  <span className="text-[12px] font-medium text-gray-800 bg-white border border-gray-200 rounded-full px-3 py-1 transition-colors duration-300 hover:border-[#39471D] hover:bg-[#E7ECD9] hover:text-[#39471D]">Competitor citation gap</span>
                  <span className="text-[12px] font-medium text-gray-800 bg-white border border-gray-200 rounded-full px-3 py-1 transition-colors duration-300 hover:border-[#39471D] hover:bg-[#E7ECD9] hover:text-[#39471D]">Question map</span>
                </div>
              </div>
            </div>
            ...
            <div ref={step2Ref} className="opacity-40 transition-opacity duration-500 flex gap-6 items-start justify-center lg:justify-start">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-1.5 mt-3.5">
                  <span className="text-[12px] font-medium text-gray-800 bg-white border border-gray-200 rounded-full px-3 py-1 transition-colors duration-300 hover:border-[#39471D] hover:bg-[#E7ECD9] hover:text-[#39471D]">Data studies</span>
                  <span className="text-[12px] font-medium text-gray-800 bg-white border border-gray-200 rounded-full px-3 py-1 transition-colors duration-300 hover:border-[#39471D] hover:bg-[#E7ECD9] hover:text-[#39471D]">Research reports</span>
                  <span className="text-[12px] font-medium text-gray-800 bg-white border border-gray-200 rounded-full px-3 py-1 transition-colors duration-300 hover:border-[#39471D] hover:bg-[#E7ECD9] hover:text-[#39471D]">Whitepapers</span>
                  <span className="text-[12px] font-medium text-gray-800 bg-white border border-gray-200 rounded-full px-3 py-1 transition-colors duration-300 hover:border-[#39471D] hover:bg-[#E7ECD9] hover:text-[#39471D]">Definitive guides</span>
                </div>
              </div>
            </div>
            ...
            <div ref={step3Ref} className="opacity-40 transition-opacity duration-500 flex gap-6 items-start justify-center lg:justify-start">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-1.5 mt-3.5">
                  <span className="text-[12px] font-medium text-gray-800 bg-white border border-gray-200 rounded-full px-3 py-1 transition-colors duration-300 hover:border-[#39471D] hover:bg-[#E7ECD9] hover:text-[#39471D]">Technical SEO</span>
                  <span className="text-[12px] font-medium text-gray-800 bg-white border border-gray-200 rounded-full px-3 py-1 transition-colors duration-300 hover:border-[#39471D] hover:bg-[#E7ECD9] hover:text-[#39471D]">Pillar pages</span>
                  <span className="text-[12px] font-medium text-gray-800 bg-white border border-gray-200 rounded-full px-3 py-1 transition-colors duration-300 hover:border-[#39471D] hover:bg-[#E7ECD9] hover:text-[#39471D]">Generative Engine Optimization</span>
                </div>
              </div>
            </div>
            ...
            <div ref={step4Ref} className="opacity-40 transition-opacity duration-500 flex gap-6 items-start justify-center lg:justify-start">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-1.5 mt-3.5">
                  <span className="text-[12px] font-medium text-gray-800 bg-white border border-gray-200 rounded-full px-3 py-1 transition-colors duration-300 hover:border-[#39471D] hover:bg-[#E7ECD9] hover:text-[#39471D]">LinkedIn</span>
                  <span className="text-[12px] font-medium text-gray-800 bg-white border border-gray-200 rounded-full px-3 py-1 transition-colors duration-300 hover:border-[#39471D] hover:bg-[#E7ECD9] hover:text-[#39471D]">Communities</span>
                  <span className="text-[12px] font-medium text-gray-800 bg-white border border-gray-200 rounded-full px-3 py-1 transition-colors duration-300 hover:border-[#39471D] hover:bg-[#E7ECD9] hover:text-[#39471D]">Podcasts</span>
                  <span className="text-[12px] font-medium text-gray-800 bg-white border border-gray-200 rounded-full px-3 py-1 transition-colors duration-300 hover:border-[#39471D] hover:bg-[#E7ECD9] hover:text-[#39471D]">Newsletters</span>
                </div>
              </div>
            </div>
