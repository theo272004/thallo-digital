    ...
    <div className="hero-copy flex flex-col justify-center pr-10" style={{ zIndex: 10 }}>
      ...
      <SplitReveal
        ...
        html={
          ...
          '<span class="block mt-2"><span class="inline-block font-serif italic text-gray-900 bg-[#758061] px-2 py-0.5 rounded-[3px] mr-1 leading-tight">AI</span><span class="font-sans">recommends.</span></span>'
        }
      />
