...
export default function ResultsDashboard() {
  ...
  return (
    <section className="bg-gray-50/50 py-16 xl:py-24 min-h-[80vh] flex flex-col justify-center border-b border-gray-100 relative overflow-hidden" id="results" ref={containerRef}>
